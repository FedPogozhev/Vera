package com.fedx.vera.ui.products.group_construction_material.plastic
...
import com.fedx.vera.databinding.PlasticFragmentBinding
...
class PlasticFragment : Fragment() {
    ...
    private val viewModel: PlasticViewModel by lazy {
        ViewModelProviders.of(this).get(PlasticViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        val binding = PlasticFragmentBinding.inflate(inflater)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.top_menu_goods_sort_name_goods ->
                viewModel.getFilterWithSort(GroupsGoods.PLASTIC, SortGoods.NAME)
            R.id.top_menu_goods_sort_price ->
                viewModel.getFilterWithSort(GroupsGoods.PLASTIC, SortGoods.PRICE)
        }
        return true
    }
}
