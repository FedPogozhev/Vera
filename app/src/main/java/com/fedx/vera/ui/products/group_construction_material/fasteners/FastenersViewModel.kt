...
class FastenersViewModel : ViewModel() {
    ...
    init {
        getFasteners(GroupsGoods.FASTENERS)
    }

    private fun getFasteners(filter:GroupsGoods) {
        coroutineScope.launch {
            ...
            try {
                ...
                Log.d("ViewModel fasteners", listResult.toString())
